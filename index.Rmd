...
# create link
link = "https://paultanger.github.io/COVID_LIC/nationalregions.html#"
...
# create link
link2 = "https://paultanger.github.io/COVID_LIC/subnationalregions.html#"
...
For countries with sub-national regional crops, you can view the information [here](https://paultanger.github.io/COVID_LIC/subnationalregions.html).

```{r make-country-region-links, echo = FALSE, results='asis'}
# or maybe just make one big list of countries and don't highlight the two groups?
#pandoc.p("This is a Heading in Code", level = 2)
cat("  \n")
cat(countries.regions$linkMd)
cat("  \n")
#lapply(as.vector(countries.regions$linkMd), FUN=cat)
```

## [Countries with national level crop calendars](https://paultanger.github.io/COVID_LIC/nationalregions.html)

For countries with crops grown throughout the country you can view the information [here](https://paultanger.github.io/COVID_LIC/nationalregions.html).

```{r make-country-links, echo = FALSE, results='asis'}
cat("  \n")
cat(countries$linkMd)
cat("  \n")
```
