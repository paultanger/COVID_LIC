...
```{r country-plots-{{names(combined.plots[i])}}, fig.align='center', fig.width=6, echo = FALSE, warning = FALSE}
...
```{r country-maps-{{names(combined.plots[i])}}, fig.width=5, fig.align = 'center', echo = FALSE}
  #out.width = "60%", 
