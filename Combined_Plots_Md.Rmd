---
pagetitle: "COVID Modeling and the Crop Cycle" 
title: |  
  <center> ![logo](Horizontal_RGB_294.png){width='50%'}  
  COVID Modeling and the Crop Cycle  </center>  
author: |  
...
# for testing
#combined.plots = readRDS(paste0(datadir, "combined.plots.for.testing.RDS"))
...
```{r run_loop, echo=FALSE, results='asis'}
